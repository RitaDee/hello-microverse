...
<details>
  <summary>Used linters to search and fix errors</summary>
  <ul>
...
```
  git clone git@github.com:RitaDee/hello-microverse.git
```
...
Feel free to check the [issues page](https://github.com/RitaDee/hello-microverse/issues).
...
God Almighty and Microverse for the opportunity.
